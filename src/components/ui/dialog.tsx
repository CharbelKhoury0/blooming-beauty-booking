  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Desktop (md+): centered, max-w-5xl, rounded, p-6, translate to center
        "md:left-[50%] md:top-[50%] md:translate-x-[-50%] md:translate-y-[-50%] md:w-full md:max-w-5xl md:h-auto md:max-h-[90vh] md:rounded-lg md:p-6",
