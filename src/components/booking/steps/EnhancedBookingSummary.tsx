...
export const EnhancedBookingSummary = ({ 
  ...
  const handleSubmit = async () => {
    ...
    try {
      // For now, we'll create one booking per person since the DB doesn't support complex multi-person bookings yet
      const mainPerson = bookingData.peopleBookings[0];
      const mainStylist = mainPerson.services[0]?.stylist;

      const bookingRequest: BookingRequest = {
        salon_id: bookingData.salon.id,
        confirmation_number: '', // Will be generated by the database function
        ...
        stylist_id: mainStylist?.id !== 'any' ? mainStylist?.id : undefined,
        stylist_name: mainStylist?.name || 'Any Available Stylist',
