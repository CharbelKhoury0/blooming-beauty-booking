...
export const HeroSection = ({ onBookingClick, salon }: HeroSectionProps) => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-20 h-20 bg-primary/10 rounded-full blur-xl opacity-60" />
      <div className="absolute bottom-20 left-10 w-32 h-32 bg-secondary/10 rounded-full blur-xl opacity-60" />
    </section>
  );
};